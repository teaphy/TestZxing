...
object Intents {
	...
	object Scan {
		 ...
		 * the results.
		 */
		val ACTION = "com.teaphy.testzxing.SCAN"

		/**
		 * By default, sending this will decode all barcodes that we understand. However it
		 * may be useful to limit scanning to certain formats. Use
		 * [Intent.putExtra] with one of the values below.
		 *
		...
		/**
		 * Call [Intent.getStringExtra] with `RESULT_FORMAT`
		...
		/**
		 * Call [Intent.getStringExtra] with `RESULT_UPC_EAN_EXTENSION`
		...
		/**
		 * Call [Intent.getByteArrayExtra] with `RESULT_BYTES`
		 ...
		 * Call [Intent.getIntArrayExtra] with `RESULT_ORIENTATION`.
		 */
		 ...
		 * Call [Intent.getStringExtra] with `RESULT_ERROR_CORRECTION_LEVEL`.
		 */
		 ...
		 * Call [Intent.getByteArrayExtra] with these keys.
		 */
	...
	object Encode {
		 ...
		 */
		val ACTION = "com.teaphy.testzxing.ENCODE"

		/**
		 * The data to encode. Use [Intent.putExtra] or
		 * [Intent.putExtra],
		 ...
		 * [Intent.putExtra] with one of [Contents.Type].
		 */
		val TYPE = "ENCODE_TYPE"

		/**
		 * The barcode format to be displayed. If this isn't specified or is blank,
		 * it defaults to QR Code. Use [Intent.putExtra], where
	...
	object SearchBookContents {
		 ...
		 */
		val ACTION = "com.teaphy.testzxing.SEARCH_BOOK_CONTENTS"
	...
	object WifiConnect {
		 ...
		 */
		val ACTION = "com.teaphy.testzxing.WIFI_CONNECT"
	...
	object Share {
		 ...
		 */
		val ACTION = "com.teaphy.testzxing.SHARE"
	}
}
